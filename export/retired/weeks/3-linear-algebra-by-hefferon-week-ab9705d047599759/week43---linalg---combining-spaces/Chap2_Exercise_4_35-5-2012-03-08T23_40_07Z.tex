...
Lemma 1: If $\vec{v} \in (W_1 \cap W_2) + (W_1 \cap W_3)$ then we can always find exactly one vector in $(W_1 \cap W_2)$ and exactly one vector in $(W_1 \cap W_3)$ to form $\vec{v}$ as their linear combination .\\\\
%
